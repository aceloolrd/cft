...
def main(data_path: str, model_save_path: str) -> None:
    """
    Основная функция для обучения модели DecisionTreeClassifier, выполнения настройки гиперпараметров,
    ...
    # Создание и обучение модели DecisionTreeClassifier с настройкой гиперпараметров с использованием кросс-валидации
    pipeline = Pipeline([
...
if __name__ == "__main__":
    ...
    model_save_path = 'tree.pkl'  # Замените на путь для сохранения модели
